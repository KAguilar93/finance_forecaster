...
from finance_forecaster.config import MODELS_DIR, PROCESSED_DATA_DIR
from finance_forecaster.logging_config import get_logger, setup_logging
from finance_forecaster.models.model import Model

logger = get_logger(__name__)


def predict(model_path: Path, input_path: Path, output_path: Path) -> None:
    """Load a trained model and write predictions for ``input_path``
    to ``output_path``."""
