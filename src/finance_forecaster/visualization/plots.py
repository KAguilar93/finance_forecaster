...
def save_lstm_training_plots(history_df: pd.DataFrame, ticker: str, figures_dir: str) -> None:
...
def save_regime_aware_equity_curve(backtest_df: pd.DataFrame, ticker: str, figures_dir: str) -> None:
